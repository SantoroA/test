...
import { DOCUMENTS_QUERY_DOCVIEW, VIEW_DOC_MUTATION } from '../../context/GraphQl/graphQlQuery';
//CUSTOM UI
...
const TabPatientDocs = ({ idHCP, idPatient }) => {
	...
	const [ doctorViewDoc ] = useMutation(VIEW_DOC_MUTATION, {
		refetchQueries: () => [
			{
				query: DOCUMENTS_QUERY_DOCVIEW,
				variables: {
					idHCP,
					idPatient
				}
