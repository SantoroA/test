...
function Row({ value }) {
	...
	const { profileHCPid, appointmentTimeStart, appointmentTimeEnd, patientComent, docStatus, _id, accountHCPid } = value;
	...
	return (
		<TableRow>
			...
			<input type="file" onChange={onFileChange} />
				<IconButton onClick={() => {onFileUpload(documentSelected)} } >
					<EditIcon />
				</IconButton>
