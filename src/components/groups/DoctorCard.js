		...
		<div className={classes.mainContent}>
			<form onSubmit={props.getAppointment}>
				<Card className={classes.card}>
					<CardMedia className={classes.media} image={props.image} title="Doctor" />
					<Box borderLeft={15} borderColor="grey.300" />
					<CardContent className={classes.content}>
						...
						<Box className={classes.contentInfo}>
							...
							<Typography variant="body2" color="textSecondary" className={classes.hours} component="p">
					...
					<CardActions className={classes.reserve}>
						<Typography variant="body2" color="textSecondary" component="p" className={classes.reserveText}>
							From
						</Typography>
						<Typography
							variant="body2"
