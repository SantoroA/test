...
// 			</Typography>
// 			<button onClick={() => getSlots({ id: '5fe8b0c48bef090026e253b7' })}>Get from Backend</button>
...
// 						<FormControlLabel
// 							control={<Checkbox checked={checked.checkedA} name="checkedA" onChange={handleChange} />}
// 							label="Sunday"
// 						/>
// 						<FormControlLabel
// 							control={<Checkbox checked={checked.checkedB} name="checkedB" onChange={handleChange} />}
// 							label="Monday"
// 						/>
// 						<FormControlLabel
// 							control={<Checkbox checked={checked.checkedC} name="checkedC" onChange={handleChange} />}
// 							label="Tuesday"
// 						/>
// 						<FormControlLabel
// 							control={<Checkbox checked={checked.checkedD} name="checkedD" onChange={handleChange} />}
// 							label="Wednesday"
// 						/>
// 						<FormControlLabel
// 							control={<Checkbox checked={checked.checkedE} name="checkedE" onChange={handleChange} />}
// 							label="Thursday"
// 						/>
// 						<FormControlLabel
// 							control={<Checkbox checked={checked.checkedF} name="checkedF" onChange={handleChange} />}
// 							label="Friday"
// 						/>
// 						<FormControlLabel
// 							control={<Checkbox checked={checked.checkedG} name="checkedG" onChange={handleChange} />}
// 							label="Saturday"
// 						/>
// 					</FormGroup>
// 				</Grid>
...
// 									onChange={(e) => setAvailableEnd(e.target.value)}
// 								/>
// 								<select defaultValue={el.slot} onChange={(e) => setDuration(e.target.value)}>
...
// 								/>
// 								<input type="number" onChange={handleChangePrice} defaultValue={el.amount} />
